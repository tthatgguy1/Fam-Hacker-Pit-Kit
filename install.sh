...
echo " "
echo " "
printf "${VBLU}┌──${BCYN}Please${VBLU}─${BCYN}Press${VBLU}─${NONG}Any${VBLU}─${BCYN}Button${VBLU}─${BCYN}To${VBLU}─${NONG}Start${VBLU}─${BCYN}The${VBLU}─${BCYN}Install${VBLU}──┐${RESET}\n${VBLU}└─${BPNK}>${ACID}: "
read -n1 -r -t3
sleep 2.0
clear
...
echo " "
echo " "
printf "${VBLU}┌──${BPNK}Please${VBLU}─${BPNK}Press${VBLU}─${NONG}Any${VBLU}─${BPNK}Button${VBLU}─${BPNK}To${VBLU}─${BPNK}Execute${VBLU}─${BPNK}This${VBLU}─${BPNK}Command${VBLU}──┐${RESET}\n${VBLU}└─${BPNK}>${ACID}: "
read -n1 -r -t3
...
echo " "
printf "${VBLU}┌──${BCYN}Please${VBLU}─${BCYN}Press${VBLU}─${NONG}Any${VBLU}─${BPNK}Button${VBLU}─${BCYN}To${VBLU}─${BCYN}Execute${VBLU}─${BCYN}This${VBLU}─${BCYN}Command${VBLU}──┐${RESET}\n${VBLU}└─${BPNK}>${ACID}: "
read -n1 -r -t3
clear
...
date +"%l:%M:%S %p" | lolcat
echo " "
printf "${VBLU}Creating ${BPNK}termux${BCYN}-${BPNK}file${BCYN}-${BPNK}editor Now\n"
sleep 2.0
chmod +x termux-file-editor
mv termux-file-editor ~/bin/
echo " "
printf "${VBLU}┌──${BPNK}Please${VBLU}─${BCYN}Press${VBLU}─${NONG}Any${VBLU}─${BCYN}Button${VBLU}─${BCYN}To${VBLU}─${BPNK}Execute${VBLU}─${BCYN}This${VBLU}─${BCYN}Command${VBLU}──┐${RESET}\n${VBLU}└─${ACID}>${NONG}: "
read -n1 -r -t3
clear
